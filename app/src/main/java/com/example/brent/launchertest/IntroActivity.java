...
//        FrameLayout.LayoutParams lpp = new FrameLayout.LayoutParams(dm.widthPixels, 100);
//        lpp.gravity= Gravity.BOTTOM;
//        lpp.setMargins(0,0,0,50);
//
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if(event.getAction() == MotionEvent.ACTION_UP) {
                        ...
                        if (vidView.isPlaying()) {
                            Log.i("Video", "VidView still playing, pausing");
//                            currentPosition = vidView.getCurrentPosition();
                            mp.pause();
                        } else {
                            Log.i("Video", "VidView paused resuming at " + currentPosition);
